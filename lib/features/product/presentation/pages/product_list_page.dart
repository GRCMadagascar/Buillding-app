...
class _ProductListPageState extends State<ProductListPage> {
  ...
  void _confirmDelete(BuildContext ctx, Product product) {
          ...
          children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () => _scanQR(const [] as List<Product>),
            ...
            Expanded(
              child: shopId.isEmpty
                  ? const Center(child: Text('Aucun magasin sélectionné.'))
                  : StreamBuilder<List<Product>>(
                      ...
                      builder: (context, snap) {
                        ...
                        if (filteredProducts.isEmpty)
                          return const Center(
                              child:
                                  Text("Aucun produit trouvé. Ajoutez-en !"));
